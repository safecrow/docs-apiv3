...
Поле `with_foreign` входит в разряд дополнительных возможностей и требует подписания Дополнительного соглашения на подключение к сервису пользователей - нерезидентов РФ.
Данное поле указывает на наличие/отсутствие участника-нерезидента РФ в сделке.
...
| with_foreign | наличие/отсутствие участника-нерезидента РФ в сделке. `true` или `false`
...
*Пример запроса с участником - нерезидентом РФ*
